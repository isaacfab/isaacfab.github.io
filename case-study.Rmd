...
3 Features
  * **8190** observations 
  * weekly data ranging from `2010-02-05` to `013-07-26` 
...
With a standard Seasonal Decomposition model we get a RMSE: **5714** and a WRMSE of **5497**
...
The performance of the three algorithms after fine tuning doing feature engineering and hypermarket exploration.
...
* ML models will be designed around the uncertainly in these DA models
