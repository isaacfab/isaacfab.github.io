...
subtitle: "AI Generated Signals of Threats and Collaborative Decisions"
...
.pull-left[
Install the **metalog** package from [Github](https://github.com/isaacfab/rmetalog):

```{r eval=FALSE, tidy=FALSE}
devtools::install_github("isaacfab/rmetalog")
```
